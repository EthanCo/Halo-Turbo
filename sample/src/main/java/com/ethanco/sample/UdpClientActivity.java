...
public class UdpClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(targetIP)) {
                    Toast.makeText(UdpClientActivity.this, "目标IP不能为空", Toast.LENGTH_SHORT).show();
                }
        ...
        binding.btnSendData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (session == null) {
                    Toast.makeText(UdpClientActivity.this, "未建立连接", Toast.LENGTH_SHORT).show();
                } else {
    ...
    class DemoHandler extends IHandlerAdapter {
        ...
        public void sessionOpened(final ISession session) {
            UdpClientActivity.this.session = session;
        ...
        public void sessionClosed(ISession session) {
            ...
            UdpClientActivity.this.session = null;
        }
    }
}
